...
windows(height = 9, width = 6)
par(mfrow =c(3,3),omi = c(1.5,0.5,0.5,0.1), mai = c(0.3,0.3,0.1,0.1))

# Low Coupling # 
plot(zoopB$doy, log(zoopB$biomass), yaxt = "n", xlim=c(140, 245), ylim=c(log(.1), log(800)),
     cex = .75, pch = 17, lty = 1, col = low_col_B, type = 'l', lwd = 2,
     xlab = "", ylab = "", cex.axis= 1.2)
par(new = TRUE) #add new smooth to the same plot
plot(zoopF$doy, log(zoopF$biomass),ylim=c(log(.1), log(800)), xlim=c(140, 245),
...
# Intermediate # 
plot(zoopA$doy, log(zoopA$biomass), yaxt = "n", xlim=c(140, 245), ylim=c(log(.1), log(800)),
     cex = .75, pch = 17, lty = 1, col = int_col_A, type = 'l', lwd = 2,
     xlab = "", ylab = "", cex.axis= 1.2)
par(new = TRUE) #add new smooth to the same plot
plot(zoopD$doy, log(zoopD$biomass),ylim=c(log(.1), log(800)), xlim=c(140, 245),
     cex = 0.75, pch = 16,  lty = 3, col = 'gray40',type = 'l', lwd = 2, yaxt='n',
     xlab = "", ylab = "", cex.axis= 1.2)
#mtext(side = 2, line = 3, "ZP Biomass (ug/L)", cex = 1.25)
...
# High # 
plot(zoopC$doy, log(zoopC$biomass), yaxt = "n", xlim=c(140, 245), ylim=c(log(.1), log(800)),
     cex = .75, pch = 17, lty = 1, col = high_col_C, type = 'l', lwd = 2,
     xlab = "", ylab = "", cex.axis= 1.2)
par(new = TRUE) #add new smooth to the same plot
plot(zoopE$doy, log(zoopE$biomass),ylim=c(log(.1), log(800)), xlim=c(140, 245),
     cex = 0.75, pch = 16,  lty = 3, col = 'gray40',type = 'l', lwd = 2, yaxt='n',
     xlab = "", ylab = "", cex.axis= 1.2)
#mtext(side = 2, line = 3, "ZP Biomass (ug/L)", cex = 1.25)
...
max(daily_miv_density$density) # 15000
min(daily_miv_density$density) # 900
...
# Low Coupling # 
plot(mivB$doy, log(mivB$density), yaxt = "n", xlim=c(140, 245), ylim=c(log(900), log(15000)),
     cex = .75, pch = 17, lty = 1, col = low_col_B, type = 'l', lwd = 2,
     xlab = "", ylab = "", cex.axis= 1.2)
par(new = TRUE) #add new smooth to the same plot
plot(mivF$doy, log(mivF$density),ylim=c(log(900), log(15000)), xlim=c(140, 245),
     cex = 0.75, pch = 16,  lty = 3, col = 'gray40',type = 'l', lwd = 2, yaxt = 'n',
     xlab = "", ylab = "", cex.axis= 1.2)
mtext(side = 2, line = 3, "ZB Density (#/m^2)", cex = 1.25)
#legend('topright', legend = c('Disturbed', 'Reference'), lty = c(1,3), col = c(low_col_B, 'gray40'))
axis(side=2,
...
# Intermediate # 
plot(mivA$doy, log(mivA$density), yaxt = "n", xlim=c(140, 245), ylim=c(log(900), log(15000)),
     cex = .75, pch = 17, lty = 1, col = int_col_A, type = 'l', lwd = 2,
     xlab = "", ylab = "", cex.axis= 1.2)
par(new = TRUE) #add new smooth to the same plot
plot(mivD$doy, log(mivD$density),ylim=c(log(900), log(15000)), xlim=c(140, 245),
     cex = 0.75, pch = 16,  lty = 3, col = 'gray40',type = 'l', lwd = 2, yaxt='n',
     xlab = "", ylab = "", cex.axis= 1.2)
#legend('topright', legend = c('Disturbed', 'Reference'), lty = c(1,3), col = c(int_col_A, 'gray40'))
axis(side=2,
...
# High # 
plot(mivC$doy, log(mivC$density), yaxt = "n", xlim=c(140, 245), ylim=c(log(900), log(15000)),
     cex = .75, pch = 17, lty = 1, col = high_col_C, type = 'l', lwd = 2,
     xlab = "", ylab = "", cex.axis= 1.2)
par(new = TRUE) #add new smooth to the same plot
plot(mivE$doy, log(mivE$density),ylim=c(log(900), log(15000)), xlim=c(140, 245),
     cex = 0.75, pch = 16,  lty = 3, col = 'gray40',type = 'l', lwd = 2, yaxt='n',
     xlab = "", ylab = "", cex.axis= 1.2)
...
plot(periB$collect, periB$biomass_area,  xlim=c(140, 245), ylim=c(0, 0.35),
     ...
     xlab = "", ylab = "", cex.axis= 1.2)
par(new = TRUE) #add new smooth to the same plot
plot(periF$collect, periF$biomass_area,ylim=c(0, 0.35), xlim=c(140, 245),
     cex = 0.75, pch = 16,  lty = 3, col = 'gray40',type = 'l', lwd = 2,
     xlab = "", ylab = "", cex.axis= 1.2)
mtext(side = 2, line = 3, "Periphyton (ug/cm^2)", cex = 1.25)
#legend('topright', legend = c('Disturbed', 'Reference'), lty = c(1,3), col = c(low_col_B, 'gray40'))


# Intermediate # 
plot(periA$collect, periA$biomass_area,  xlim=c(140, 245), ylim=c(0, 0.35),
     cex = .75, pch = 17, lty = 1, col = int_col_A, type = 'l', lwd = 2,
     xlab = "", ylab = "", cex.axis= 1.2)
par(new = TRUE) #add new smooth to the same plot
plot(periD$collect, periD$biomass_area,ylim=c(0, 0.35), xlim=c(140, 245),
     cex = 0.75, pch = 16,  lty = 3, col = 'gray40',type = 'l', lwd = 2,
     xlab = "", ylab = "", cex.axis= 1.2)
#legend('topright', legend = c('Disturbed', 'Reference'), lty = c(1,3), col = c(int_col_A, 'gray40'))
...
# High # 
plot(periC$collect, periC$biomass_area,  xlim=c(140, 245), ylim=c(0, 0.35),
     cex = .75, pch = 17, lty = 1, col = high_col_C, type = 'l', lwd = 2,
     xlab = "", ylab = "", cex.axis= 1.2)
par(new = TRUE) #add new smooth to the same plot
plot(periE$collect, periE$biomass_area,ylim=c(0, 0.35), xlim=c(140, 245),
     cex = 0.75, pch = 16,  lty = 3, col = 'gray40',type = 'l', lwd = 2, 
     xlab = "", ylab = "", cex.axis= 1.2)
#legend('topright', legend = c('Disturbed', 'Reference'), lty = c(1,3), col = c(high_col_C, 'gray40'))
